...
export const fetchTopping = createAsyncThunk('topping/fetchTopping', async () => {
    const data = await getListTopping();
    return data;
});

// Async thunk để thêm mới Topping
export const addNewTopping = createAsyncThunk('topping/addTopping', async (formData: Topping, thunkAPI) => {
    try {
...
export const updateToppingThunk = createAsyncThunk(
    ...
    async ({ id, formData }: { id: string, formData: Topping }, thunkAPI) => {
        try {
            ...
            return thunkAPI.rejectWithValue(error.message || 'Error updating Topping');
        }
    }
);
...
const toppingSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(fetchTopping.fulfilled, (state, action: PayloadAction<Topping[]>) => {
            ...
            .addCase(addNewTopping.fulfilled, (state, action: PayloadAction<Topping>) => {
            ...
            .addCase(updateToppingThunk.fulfilled, (state, action: PayloadAction<Topping>) => {
