...
const OrderDetailModal: React.FC<OrderDetailModalProps> = ({
  ...
  const handleDelete = () => {
    Alert.alert('Xác nhận xóa', 'Bạn có chắc chắn muốn xóa oder này không?', [
      {
        text: 'Hủy',
          ...
          {loading ? (
            ...
            <>
              <Text style={styles.text}>
                Tên món: <Text style={styles.bold}>{monAn.tenMon}</Text>
              </Text>
              <Text style={styles.text}>
                Số lượng: <Text style={styles.bold}>{order.quantity}</Text>
              </Text>
              <Text style={styles.text}>
                Vị trí: <Text style={styles.bold}>Bàn {ban.tenBan}</Text>
              </Text>
              <Text style={styles.text}>
                Trạng thái:
                <Text
                  style={
                    order.status ? styles.statusCompleted : styles.statusPending
                  }>
