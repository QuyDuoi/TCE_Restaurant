...
const ThongKeHinhThucThanhToan = () => {
  const noDataImageURL =
    'https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcRzlNmuaJh6jvjDXesEjjS-1ZqS1GnsE8jb2mY8XjwqrSoim8N4';
  ...
  const fetchRevenueData = async (type, startDate, endDate) => {
    try {
      setIsLoading(true);
      let url = `${ipAddress}thongKeHinhThucThanhToan?type=${type}&id_nhaHang=${id_nhaHang}`;
      ...
      const tongChuyenKhoan = data?.tongChuyenKhoan ?? 0;
      const tongTienMat = data?.tongTienMat ?? 0;

      setRevenue(tongChuyenKhoan);
      setPromotion(tongTienMat);
    } catch (error) {
                ...
                <>
                  ...
                  <View style={styles.legendContainer}>
                    <View style={styles.legendItemContainer}>
                      <Text style={styles.legendLabel}>Tiền Mặt</Text>
                      <View
                        style={[
                          styles.legendItem,
                    ...
                    <View style={styles.legendItemContainer}>
                      <Text style={styles.legendLabel}>Chuyển Khoản</Text>
                      <View
                        style={[
                          styles.legendItem,
