...
const BlogPostPublishedModal = ({ title, content, onConfirm }) => {
                    ...
                    <View style={styles.modalView}>
                        <View style={styles.header}>
                            <View style={styles.iconCircle}>
                                <FontAwesomeIcon icon={faCircleCheck} size={20} color={'#12B76A'} />
                            </View>
                        ...
                        <View style={styles.buttonContainer}>
                            ...
                            <TouchableOpacity
                                ...
                                onPress={() => {
                                    if (onConfirm) {
                                        onConfirm(); // Gọi hàm callback khi nhấn "Xác nhận"
                                    }
                                    setModalVisible(!modalVisible);
                                }}
                            >
...
const styles = StyleSheet.create({
    ...
    iconCircle: {
        ...
        height: 40,
        borderRadius: 20,
        backgroundColor: '#E6F4EA', // Màu nền của icon tròn
        justifyContent: 'center',
        alignItems: 'center',
    },
    closeIcon: {
        // Style cho icon close nằm ở góc phải
    },
    modalTitle: {
        fontSize: 18,
        fontWeight: '600',
...
export default BlogPostPublishedModal;
