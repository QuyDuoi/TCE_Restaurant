...
import { View, Text, StyleSheet, TextInput, TouchableOpacity, Alert, Image, KeyboardAvoidingView, ScrollView, Modal, Pressable } from 'react-native';
...
import { launchCamera, launchImageLibrary } from 'react-native-image-picker';
  ...
  const ProductDetailScreen = () => {
    ...
    const [productDescription, setProductDescription] = useState('Rau muống, tỏi');
    const [productStatus, setProductStatus] = useState(true);
    const [selectedTopping, setSelectedTopping] = useState(['1', '2']);
    const [productImage, setProductImage] = useState({ uri: 'https://i.pinimg.com/236x/59/f0/d0/59f0d0067c5d04c5db5f92f517767002.jpg' }); // Ảnh mặc định
    ...
    useEffect(() => {
      ...
      if (
        ...
        productPrice !== '15000' ||
        productDescription !== 'Rau muống, tỏi' ||
        selectedCategory !== '1' ||
    ...
    }, [productName, productPrice, productDescription, selectedCategory, selectedTopping]);
    ...
    return (
      <KeyboardAvoidingView style={styles.container} behavior="padding">
        ...
        {/* Nút lưu */}
        <TouchableOpacity
          style={[styles.saveButton, hasChanges ? styles.saveButtonActive : styles.saveButtonInactive]}
        ...
        <Modal visible={showImageOptions} transparent={true} animationType="slide">
          <Pressable style={styles.modalBackground} onPress={() => setShowImageOptions(false)}>
