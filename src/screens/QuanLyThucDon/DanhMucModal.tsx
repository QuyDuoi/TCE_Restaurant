...
const CategoryModal: React.FC<CategoryModalProps> = ({
  ...
  const [originalCategoryName, setOriginalCategoryName] =
    useState(categoryName);

  const [selectedToppings, setSelectedToppings] = useState(
    topping.map(topping => topping.id),
  );
        ...
        <SafeAreaView style={styles.modalContentDanhMuc}>
          <ScrollView contentContainerStyle={styles.scrollViewContent}>
            ...
            <Text style={styles.value}>
              {isAddingNew ? 'Tự tạo mã' : categories.id}
            </Text>
            ...
            {linkedDishes.map((dish, index) => (
              <View key={index} style={styles.linkedDishContainer}>
                ...
                <TouchableOpacity
                  onPress={() => removeLinkedDish(dish)}
                  style={styles.linkedDishRemoveButton}>
            ...
            <View style={styles.modalOverlay}>
              <View style={styles.modalContent}>
                ...
                <FlatList
                  ...
                  renderItem={({item}) => (
                    <TouchableOpacity
                      onPress={() => addLinkedDish(item.name)}
