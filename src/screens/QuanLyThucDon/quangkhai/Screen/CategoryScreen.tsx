...
import { View, Text, FlatList, StyleSheet, SafeAreaView, TouchableOpacity, Modal, Alert, Button } from 'react-native';
import CategoryModal from '../Modal/DanhMucModal';
...
const categories: Category[] = [
    { id: 1, name: 'Pizza', items: [{ id: 1, name: 'Cheese', price: 666 }, { id: 2, name: 'Pepperoni', price: 666 }, { id: 3, name: 'Vegetable', price: 666 }] },
    { id: 2, name: 'Burger', items: [{ id: 4, name: 'Beef', price: 666 }, { id: 5, name: 'Chicken', price: 666 }, { id: 6, name: 'Vegan', price: 666 }] },
        ...
        <SafeAreaView style={styles.container}>
            ...
            {selectedCategory && (
                <CategoryModal
                    ...
                    items={Array.isArray(selectedCategory?.items) ? selectedCategory.items : []} // Kiểm tra nếu items là một mảng, nếu không thì truyền mảng rỗng
